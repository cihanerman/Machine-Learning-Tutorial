...
#endregion
#region KNN
knn = KNeighborsClassifier(n_neighbors=3) # n_neighbors knn deki k değeri
knn.fit(x_train, y_train)
# predict = knn.predict(x_test)
print 'k: {} değerinde skor: {}'.format(3,knn.score(x_test, y_test))
#endregion
#region find k value
score_list = []

for x in range(1,15):
    knn2 = KNeighborsClassifier(n_neighbors=x) # n_neighbors knn deki k değeri
